        ...
        var purchasePlanConfig = [
            {
                ...
                intervalPurchase: [0, 200000],                  // 采购段 0 <= 总额 < 20万 的情况
                applicantTypes: ["leader", "member"],           // 类目主管和运营专员可以创建
                handlerTypes: [                                 // 流程：类目主管 -> 运营经理 -> 采购主管
                    ["leader", "member"],
                    ["director"],
                    ["manager"],
                    ["purchaseDirector"]
            ...
            {
                intervalGotNew: [100000, 300000],                    // 有新产品的订单 10万 <= 总额 < 30万 的情况
                intervalNoNew: [200000, 500000],                     // 无新产品的订单 20万 <= 总额 < 30万 的情况
                intervalPurchase: [200000, 500000],                  // 采购段 20万 <= 总额 < 30万 的情况
                applicantTypes: ["leader", "member"],           // 类目主管和运营专员可以创建
            ...
            {
                intervalGotNew: [300000, 9999999999],           // 有新产品的订单 30万 <= 总额 的情况  这里还是设置了一个上限，这个是1000亿，单个订单有那么多可能性不大
                intervalNoNew: [500000, 9999999999],            // 无新产品的订单 30万 <= 总额 的情况
                intervalPurchase: [500000, 9999999999],         // 采购段 30万 <= 总额 的情况
                applicantTypes: ["leader", "member"],           // 类目主管和运营专员可以创建
                handlerTypes: [                                 // 流程：类目主管 -> 运营经理 -> 运营总监 -> CEO -> 供应链主管 -> 供应链总监 -> CEO
                    ["leader", "member"],
                    ["director"],
                    ["manager"],
                    ["COO"],
                ...
                statuses: [100, 200, 210, 220, 230, 300, 310, 320]        // 流程的状态： 200: 类目主管审核, 210: 运营经理审核, 220: 运营总监审核, 230: CEO审核, 300: 供应链主管审核, 310: 供应链总监, 320: CEO
            }
        ];
